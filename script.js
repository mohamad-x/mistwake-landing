...
function detailSection(){
  ...
  s.id='design-detail';
  s.innerHTML='<div class="section-header centered"><p class="eyebrow">Design details</p><h2>Nozzle and current measurements.</h2></div><div class="closeup-grid"><figure><img class="asset-placeholder-img" src="'+assetPath('assets/nozzle-closeup.webp?v=52')+'" alt="MistWake nozzle detail" loading="lazy" /><figcaption>Nozzle design direction.</figcaption></figure><figure><img class="asset-placeholder-img" src="'+assetPath('assets/dimensions.webp?v=52')+'" alt="MistWake dimensions diagram" loading="lazy" /><figcaption>Current dimensions, subject to manufacturing tolerance.</figcaption></figure></div>';
  return s;
}
...
function applyVideo(){var holder=document.querySelector('#proof-video .visual-proof-image');if(!holder||holder.querySelector('video'))return;var v=document.createElement('video');v.className='asset-placeholder-img';v.controls=true;v.playsInline=true;v.preload='metadata';v.poster=assetPath('assets/real-prototype-handheld.webp');var s=document.createElement('source');s.src=assetPath('assets/prototype-demo.mp4?v=52');s.type='video/mp4';v.appendChild(s);holder.innerHTML='';holder.appendChild(v);
  var started=false;
