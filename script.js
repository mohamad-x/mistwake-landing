...
function detailSection(){
  ...
  s.id='design-detail';
  s.innerHTML='<div class="section-header centered"><p class="eyebrow">Design details</p><h2>Nozzle and current measurements.</h2></div><div class="closeup-grid"><figure><img class="asset-placeholder-img" src="'+assetPath('assets/nozzle-closeup.webp?v=48')+'" alt="MistWake nozzle detail" loading="lazy" /><figcaption>Nozzle design direction.</figcaption></figure><figure><img class="asset-placeholder-img" src="'+assetPath('assets/dimensions.webp?v=48')+'" alt="MistWake dimensions diagram" loading="lazy" /><figcaption>Current dimensions, subject to manufacturing tolerance.</figcaption></figure></div>';
  return s;
}
...
function addVisualSections(){
  ...
  if(trust&&trust.parentNode){trust.parentNode.insertBefore(imageSection('visual-hook','The problem','Still sleeping through normal alarms?','assets/ad-sleeping-through-alarms.webp?v=48','MistWake visual explainer showing the problem of sleeping through alarms','Marketing visual used to explain the problem. Real prototype proof is shown below.'),trust.nextSibling);}
  var how=document.getElementById('how');
  if(how&&how.parentNode){how.parentNode.insertBefore(imageSection('better-way','Sound plus mist','A second cue for heavy sleepers.','assets/ad-better-way-wake-up.webp?v=48','MistWake visual explainer showing sound plus mist as a wake-up cue','Marketing visual. Actual prototype photos and video are included on this page.'),how.nextSibling);}
  var proof=document.getElementById('proof');
  if(proof&&proof.parentNode){proof.parentNode.insertBefore(imageSection('features','Feature overview','Smart mist. Better mornings.','assets/feature-overview.webp?v=48','MistWake feature overview','Feature overview is based on the current product plan and prototype direction. Final production specifications may change.'),proof.nextSibling);}
...
function applyVideo(){var holder=document.querySelector('#proof-video .visual-proof-image');if(!holder||holder.querySelector('video'))return;var v=document.createElement('video');v.className='asset-placeholder-img';v.controls=true;v.playsInline=true;v.preload='metadata';v.poster=assetPath('assets/real-prototype-handheld.webp');var s=document.createElement('source');s.src=assetPath('assets/prototype-demo.mp4?v=48');s.type='video/mp4';v.appendChild(s);holder.innerHTML='';holder.appendChild(v);
  var started=false;
